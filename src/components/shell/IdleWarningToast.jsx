  ...
  return (
    <div className="fixed bottom-6 right-5 z-[200] max-w-[340px] rounded-xl border border-primary/30 bg-surface shadow-xl px-4 py-3.5 flex items-start gap-3">
      ...
      <div className="flex-1">
        <div className="text-[14.5px] font-bold text-primary mb-1">Session Expiring Soon</div>
        ...
        <div className="text-[12.5px] text-text-muted mt-1">Click anywhere to stay logged in.</div>
      </div>
      <button
        type="button"
        onClick={dismissIdleWarning}
        className="text-text-muted text-[15px] leading-none shrink-0 mt-0.5"
      >
        ✕
      </button>
    </div>
