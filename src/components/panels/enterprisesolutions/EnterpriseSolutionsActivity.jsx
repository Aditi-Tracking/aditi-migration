...
export default function EnterpriseSolutionsActivity({ tab, transactions, scope, onScopeChange, metric, onMetricChange, detailType, onToggleDetail }) {
  ...
  return (
    <div className="rounded-2xl bg-white border border-[#e9ecf5] shadow-[0_1px_2px_rgba(15,23,42,0.04)] p-4 mb-5">
      ...
      <div className="grid grid-cols-2 gap-3.5">
        ...
        >
          <div className="w-8 h-8 rounded-lg flex items-center justify-center text-[15px] mb-1.5" style={{ background: 'rgba(0,212,170,0.14)', color: '#00d4aa' }}>
            ➕
          </div>
          <div className="text-[19px] font-extrabold text-[#111827]">{added.toLocaleString('en-IN')}</div>
          <div className="text-[11px] text-[#8891a5]">{unit} Added</div>
        </button>
        <button
          type="button"
        ...
        >
          <div className="w-8 h-8 rounded-lg flex items-center justify-center text-[15px] mb-1.5" style={{ background: 'rgba(255,92,124,0.14)', color: '#ff5c7c' }}>
            ➖
          </div>
          <div className="text-[19px] font-extrabold text-[#111827]">{removed.toLocaleString('en-IN')}</div>
          <div className="text-[11px] text-[#8891a5]">{unit} Removed</div>
        </button>
      </div>
