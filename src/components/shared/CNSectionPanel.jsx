...
export default function CNSectionPanel({ sectionName, title, breadcrumb }) {
  ...
  return (
    <div className="px-4 sm:px-6 py-5">
          ...
          {cats.map((cat) => {
            ...
            return (
              <DocCard
                ...
                onClick={() => setOpenModule({ id: cat.id, name: cat.name })}
              />
            )
          })}
        </div>
      ...
      <OverlayShell open={!!openModule} onClose={() => setOpenModule(null)} maxWidth="max-w-3xl">
        {openModule && (
          <>
